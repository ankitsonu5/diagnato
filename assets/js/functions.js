...
//stay prakash maurya styling in js functions//

$(document).ready(function() {
    // Initialize the CT scan image and data as active by default
    $('.service-img').addClass('d-none');
    $('.servicedata').addClass('d-none');
    $('#img-ctscan').removeClass('d-none');
    $('#data-ctscan').removeClass('d-none');
    $('#ctscan').addClass('active');
    ...
    $('.service_list li').click(function() {
        ...
        // Hide all service data and images
        $('.servicedata').addClass('d-none');
        $('.service-img').addClass('d-none');
        
        // Show the selected service data and image
        const serviceId = $(this).attr('id');
        $(`#data-${serviceId}`).removeClass('d-none');
        $(`#img-${serviceId}`).removeClass('d-none');
    });

    // Redirect to the homepage and reset to the first service data and image on clicking "View other Services"
    $('#view-services').click(function(e) {
        e.preventDefault();
...
// <!-- saty testimonial Section start Here -->
